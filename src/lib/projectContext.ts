export const projectContext = {
  ...
  hardwareComponents: {
    vest: [
      ...
      { name: "MPU6050 Akselerometer + Giroskop", description: "Sensor gerak 6-axis yang mengukur kemiringan dan percepatan tubuh nelayan untuk deteksi jatuh dan diam tanpa gerak.", priceUSD: 1.60, priceIDR: 25000 },
      ...
      { name: "Sensor Suhu Air/Tubuh DS18B20 (Waterproof)", description: "Sensor suhu digital kedap air untuk memantau suhu tubuh nelayan dan suhu air laut sekitar.", priceUSD: 1.30, priceIDR: 20000 },
      { name: "Sensor Cuaca & Lingkungan BME280", description: "Mengukur parameter cuaca lokal termasuk suhu udara sekitar, kelembapan, dan tekanan udara (hPa).", priceUSD: 4.80, priceIDR: 75000 },
      { name: "Sensor Deteksi Air Laut (Water Contact)", description: "Sensor konduktivitas dengan probe terbuka untuk mendeteksi jika nelayan jatuh terendam ke dalam air laut.", priceUSD: 1.00, priceIDR: 15000 },
      ...
      { name: "Baterai 18650 + Holder + BMS + Charger USB-C", description: "Sistem catu daya mandiri rompi lengkap dengan proteksi arus (BMS) dan port pengisian daya.", priceUSD: 7.70, priceIDR: 120000 },
      { name: "Tombol SOS + LED RGB + Buzzer Peringatan", description: "Tombol darurat fisik nelayan, indikator status RGB, dan buzzer alarm suara lokal.", priceUSD: 1.60, priceIDR: 25000 },
      { name: "Casing Waterproof IP67 & Antena (LoRa + GPS)", description: "Casing pelindung kedap air yang mengapung beserta antena cambuk untuk memaksimalkan pancaran RF.", priceUSD: 14.90, priceIDR: 230000 }
    ],
    baseStation: [
